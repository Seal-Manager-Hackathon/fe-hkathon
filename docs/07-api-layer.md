...
| Rounds | `/admin/events/{id}/rounds` | getRounds, createRound, updateRound, deleteRound |
...
| Awards | `/admin/events/{id}/awards` | getAwards, createAward, updateAward, deleteAward |
...
| Register Teams | `/admin/register-teams/{id}/assign-next-round`, `/admin/register-teams/{id}/revert-previous-round` | assignToNextRound, revertToPreviousRound |
| Register Team Subs | `/admin/register-teams/{id}/submissions` | getRegisterTeamSubmissions |
