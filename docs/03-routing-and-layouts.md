...
/notifications          → StudentLayout → ...
/hackathons/:id         → StudentLayout → ...
...
/staff/*                → AdminLayout → (mirror of /admin/*)
...
**Sidebar**: 248px wide, teal background (`bg-[#064f5d]`), fixed left, mobile: overlay with backdrop. Contains nav items: Dashboard, Hackathons, Teams, Users, Notifications, Reports.
...
Tabs: Overview, Rounds, Tracks, Awards, Assignments, Register Teams, Submissions.
