...
import { getSubmissionDetail, getTeamDetail, getSubmissionGraderScores, getRegisterTeamDetail, getScoreDetail, getScoreItems, getScoreItemDetail, getCriteriaTemplates, getCriteriaItems } from '../../../api/staff'
    ...
    { key: 'grader', header: 'Grader', headerIcon: User,
      render: (row) => {
        ...
        if (gb) {
          ...
          return (
            <Link to={`/staff/users/${gb.userId}`} className="inline-flex cursor-pointer items-center gap-2 rounded-lg px-1 py-0.5 transition-colors hover:bg-[#e3f2fd]/60">
              ...
              return (
                <div key={tpl.id} className="px-5 py-4">
                  <div className="mb-3 flex items-center justify-between">
                    <Link
                      to={`/staff/rounds/${data.roundId}/criteria-templates/${tpl.id}`}
