...
import { getRounds, getTracks, getTopics, getEventRegisterTeams, approveRegisterTeam, rejectRegisterTeam, banRegisterTeam, unbanRegisterTeam, assignTrackTopicToRegisterTeam, removeTrackTopicFromRegisterTeam } from '../../../../api/staff'
import { formatDateTime } from '../../../../utils/format'
import { toast, confirm } from '../../../../utils/toast'
import PromptReason from '../../../../components/PromptReason'
import { Ban, Users, Eye, FileText, Calendar, MoreHorizontal, CircleCheck, CheckCircle, XCircle, ShieldOff, FolderKanban, Layers } from 'lucide-react'
...
export default function RegisterTeamsTab({ eventId }) {
  ...
  const columns = [
    ...
    { key: 'topicTitle', header: 'Topic', headerIcon: FileText, render: (row) => row.topicId ? <Link to={`/staff/tracks/${row.trackId}/topics`} className="text-[13px] font-medium text-[#064f5d] hover:underline">{row.topicTitle || row.topicName || '—'}</Link> : <span className="text-[13px] text-gray-400">—</span> },
