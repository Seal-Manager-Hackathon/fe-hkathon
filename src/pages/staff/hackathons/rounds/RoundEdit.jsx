...
import { getRoundDetail, getEventDetail, updateRound } from '../../../../api/staff'
...
export default function RoundEdit() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      navigate(`/staff/hackathons/${event?.id || ''}?tab=Rounds`)
    } catch (err) {
  ...
  return (
    <EntityFormPage
      backUrl={`/staff/hackathons/${eventId}?tab=Rounds`}
