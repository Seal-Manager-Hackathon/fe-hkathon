...
import { getTracks, deleteTrack, restoreTrack } from '../../../../api/staff'
  ...
  return (
    <>
      <div className="mb-4 flex items-center justify-between">
        ...
        <Link to={`/staff/hackathons/${eventId}/tracks/create`} className="inline-flex cursor-pointer items-center gap-1.5 rounded-lg bg-[#064f5d] px-3 py-1.5 text-[12px] font-semibold text-white transition-colors hover:bg-[#05404a]">
          + Create Track
        </Link>
      </div>
