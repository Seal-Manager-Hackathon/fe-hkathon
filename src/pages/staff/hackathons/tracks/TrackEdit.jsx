...
import { getTrackDetail, getEventDetail, updateTrack } from '../../../../api/staff'
...
export default function TrackEdit() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      navigate(`/staff/hackathons/${event?.id || ''}?tab=Tracks`)
    } catch (err) {
  ...
  return (
    <EntityFormPage
      backUrl={`/staff/hackathons/${event?.id || ''}?tab=Tracks`}
