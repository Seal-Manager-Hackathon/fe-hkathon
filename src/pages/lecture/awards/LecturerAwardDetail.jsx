...
import { ArrowLeft, Calendar, Clock, DollarSign, Hash, Trophy, CircleCheck } from 'lucide-react'
import { getLecturerAwardDetail, getLecturerEventDetail } from '../../../api/lecturer'
...
export default function LecturerAwardDetail() {
  ...
  useEffect(() => {
    ...
    async function fetch() {
      ...
      try {
        const data = await getLecturerAwardDetail(awardId)
        ...
        <div className="space-y-5">
          <CardPanel title="Award Information">
            <div className="divide-y divide-[#f5f5f5]">
              ...
              <InfoRow label="Status" icon={CircleCheck}><Badge label="Active" className="bg-[#e8f5e9] text-[#2e7d32]" /></InfoRow>
