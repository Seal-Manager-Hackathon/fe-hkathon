...
import { Info, Layers, Users, List, Award, BarChart3, UserCheck } from 'lucide-react'
...
import LecturerAssignTab from './LecturerAssignTab'
...
const TABS = [
  ...
  { key: 'Assignment', icon: <UserCheck className="h-4 w-4" /> },
