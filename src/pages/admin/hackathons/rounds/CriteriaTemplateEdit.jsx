...
export default function CriteriaTemplateEdit() {
  ...
  return (
    <div className="px-4 py-6 md:px-6 lg:px-8 lg:py-8">
      <nav className="mb-5">
        <button onClick={() => navigate(`/admin/rounds/${roundId}/criteria-templates/${templateId}`)} className="inline-flex cursor-pointer items-center gap-1.5 text-[13px] font-medium text-[#064f5d] hover:underline">
        ...
        <div className="rounded-2xl border border-[#e8ecf0] bg-white p-6 shadow-sm">
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-end gap-3 border-t border-slate-100 pt-6">
              <button onClick={() => navigate(`/admin/rounds/${roundId}/criteria-templates/${templateId}`)} className="inline-flex cursor-pointer items-center gap-2 rounded-lg border border-slate-200 bg-white px-5 py-2.5 text-[14px] font-semibold text-slate-600 hover:bg-slate-50">Cancel</button>
