...
export default function TopicsManagement() {
  ...
  return (
    <div className="px-4 py-6 md:px-6 lg:px-8 lg:py-8">
      <div className="mb-4">
        <Link to={track?.eventId ? `/admin/hackathons/${track.eventId}?tab=Tracks` : '/admin/hackathons'} className="inline-flex items-center gap-1.5 text-[14px] font-medium text-[#064f5d] hover:underline">
