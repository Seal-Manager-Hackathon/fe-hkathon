...
function ScoreDetailModal({ scoreId, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-[92%] sm:max-w-2xl max-h-[90vh] overflow-y-auto rounded-2xl bg-white p-6 shadow-2xl">
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="bg-[#fafbfc]">
                        <th className="px-4 py-2.5 text-left text-[12px] font-bold uppercase text-slate-500">Criteria</th>
                        <th className="px-4 py-2.5 text-left text-[12px] font-bold uppercase text-slate-500 w-20">Score</th>
                        <th className="px-4 py-2.5 text-left text-[12px] font-bold uppercase text-slate-500">Comment</th>
                      </tr>
                    </thead>
