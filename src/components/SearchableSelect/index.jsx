 ...
 * @param {function} fetchFn        - (keyword: string) => Promise<Array<{ value, label, [avatar], [avatarLetter], [sub] }>>
 * @param {string}   [value]
...
export default function SearchableSelect({
  ...
  // Fetch on keyword change (debounced 300ms)
  useEffect(() => {
    ...
    <div className={`relative ${className}`}>
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-start justify-center pt-[10vh]">
          ...
          <div className="relative z-10 w-full max-w-[480px] overflow-hidden rounded-xl border border-[#e8ecf0] bg-white shadow-2xl">
            {/* Header */}
