  ...
  return (
    ...
    >
      <div className="mb-7 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Link
          to="/hackathons"
          className="inline-flex cursor-pointer items-center gap-2 rounded-lg border border-white/30 bg-white/10 px-4 py-2 text-[14px] font-semibold text-white transition-colors hover:bg-white/20"
        >
