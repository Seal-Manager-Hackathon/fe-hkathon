...
export default function SwapModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-[6vh]">
      ...
      <div className="relative z-10 flex max-h-[88vh] w-full max-w-[860px] flex-col overflow-hidden rounded-2xl border border-[#e8ecf0] bg-white shadow-2xl animate-in fade-in zoom-in-95">
        {/* ── Header ── */}
