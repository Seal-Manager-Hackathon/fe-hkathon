...
## Mission
Create implementation-ready, token-driven UI guidance for Devpost that is optimized for consistency, accessibility, and fast delivery across e-commerce storefront.
...
- Include known page component density: links (169), lists (16), buttons (11), inputs (11), navigation (9), tables (1).
